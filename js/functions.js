...
function calculateTip (tipPercent, totalBill) {
  return (tipPercent < 1) ? (tipPercent * totalBill).toFixed(2) : ((tipPercent / 100) * totalBill).toFixed(2);
}
 ...
 */
function applyDiscount (price, discPercent) {
  var discount = (discPercent < 1) ? (discPercent * price) : ((discPercent / 100) * price);
  return (price - discount).toFixed(2);
}

console.log(applyDiscount(42, 20));
